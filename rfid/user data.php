...
<html>
	<head>
		...
		<title>Clothes Data : Smart Clothes Storage</title>
	</head>
	
	<body>
		<h2>Smart Clothes Storage</h2>
		<ul class="topnav">
			<li><a href="home.php">Home</a></li>
			<li><a class="active" href="user data.php">Clothes Data</a></li>
