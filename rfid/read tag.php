...
<html>
	<head>
		...
		<title>Read Tag : Smart Clothes Storage</title>
	</head>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a href="user data.php">Clothes Data</a></li>
					...
					<tr>
						<td  bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Clothes Name</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr>
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Sleeve</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
								<tr>
									<td align="left" class="lf">Color</td>
									<td style="font-weight:bold">:</td>
									<td align="left">--------</td>
								</tr>
							</table>
